...
angular.module('UnidadDocumentalService', []).factory('UnidadDocumental', ['$http', function($http){
	return {
		...
		all: function(){
			return $http.get('/apifoto/unidadDocumental');
		},
		...
		update: function(unidadDocumentalId, unidadDocumentalData){
			return $http.put('/apifoto/unidadDocumental/' + unidadDocumentalId, unidadDocumentalData);
		},

		// Elimina una unidad documental. Recibe como parámetro el Id a borrar
		delete: function(unidadDocumentalId){
			return $http.delete('/apifoto/unidadDocumental/' + unidadDocumentalId);
		},

		// Obtiene el prefijo común de las unidades documentales
		prefix: function(){
			return $http.get('/apifoto/unidadDocumental/prefix');
		},

		// Obtiene el nombre principal de todas las unidades documentales
		name: function(){
			return $http.get('/apifoto/unidadDocumental/name');
		},
		...
		suffix: function(unidadDocumentalId){
			return $http.get('/apifoto/unidadDocumental/' + unidadDocumentalId + '/suffix');
		},
		...
		next: function(conjuntoDocumentalPrefijo){
			return $http.get('/apifoto/unidadDocumental/next?from=' + conjuntoDocumentalPrefijo);
		},
		...
		query: function(query, propiedad){
			return $http.get('/apifoto/unidadDocumental/query?q=' + query + '&from=' + propiedad);
		}
	}
}]);